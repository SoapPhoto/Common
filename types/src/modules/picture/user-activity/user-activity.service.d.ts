...
export declare class PictureUserActivityService {
    ...
    getOne: (pictureId: number, userId: number) => Promise<PictureUserActivityEntity>;
    ...
    getLikeList: (userIdOrName: string, query: GetPictureListDto, user: UserEntity) => Promise<[number, string[]]>;
