...
export declare class LocationResolver {
    ...
    searchPlace(value: string, region: string, type?: LocationClientType): Promise<import("../../shared/mapbox/mapbox.interface").IMapboxGeocodeFeature[] | import("./interface/place.interface").Place[]>;
